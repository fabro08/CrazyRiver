...
public class Game extends JPanel {
    ...
    public Clock tiempoSalud = new Clock(this,"life",3);
 ...
 ***************/
	...
	/*Funcion madre encargada de
	 *  llamar los movimientos de 
	 *  los objetos
	 * */
...
/***********************
 * Funcion de dibijar madre esta llama a 
 * la dibujar de cada objeto y lo
 * pone en pantalla
 **********************/
	...
	public void paint(Graphics g) {
		...
		g2d.drawString(String.valueOf(jefe.getBoslife()), 125, 120);
